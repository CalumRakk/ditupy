...
class PostProcessor:
    ...
    def _get_sorted_segments(self, directory: Path, init_name: str = "init.mp4") -> List[Path]:
        """
    ...
    def process(self, output_filename: str, cleanup: bool = True):
        ...
        if audio_files:
            ...
            logger.warning("No se encontraron segmentos de audio. Se generará video mudo.")
